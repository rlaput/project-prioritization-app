...
namespace ProjectPrioritizationApp.Controllers
{
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_projectsController : ProjectPrioritizationApp.Controllers.projectsController
    {
        ...
        [NonAction]
        partial void CreateOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, ProjectPrioritizationApp.Models.project project);

        [NonAction]
        public override System.Web.Mvc.ActionResult Create(ProjectPrioritizationApp.Models.project project)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Create);
        ...
        [NonAction]
        partial void EditOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, ProjectPrioritizationApp.Models.project project);

        [NonAction]
        public override System.Web.Mvc.ActionResult Edit(ProjectPrioritizationApp.Models.project project)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Edit);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "project", project);
