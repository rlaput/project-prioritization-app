...
{
    public static ProjectPrioritizationApp.Controllers.criteriaController criteria = new ProjectPrioritizationApp.Controllers.T4MVC_criteriaController();
    public static ProjectPrioritizationApp.Controllers.HomeController Home = new ProjectPrioritizationApp.Controllers.T4MVC_HomeController();
    public static ProjectPrioritizationApp.Controllers.projectsController projects = new ProjectPrioritizationApp.Controllers.T4MVC_projectsController();
    public static ProjectPrioritizationApp.Controllers.scoresController scores = new ProjectPrioritizationApp.Controllers.T4MVC_scoresController();
